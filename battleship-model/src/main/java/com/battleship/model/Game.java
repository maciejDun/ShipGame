...
public class Game {
    ...
    public Game addPlayer2(Player player2){
        ...
        log.info("com.battleship.model.Player: " + player2.getUsername() + " has joined a game: " + this.gameName);
        return this;
    }
    ...
    public void gameOver(){
        ...
        log.info("com.battleship.model.Game is over");
        log.info("com.battleship.model.Player: " + this.player1.getUsername() + " score: " + player1.getPlayerScore());
        log.info("com.battleship.model.Player: " + this.player2.getUsername() + " score: " + player2.getPlayerScore());
        if (player1.getIsLost()) {
            log.info("com.battleship.model.Player: " + this.player2.getUsername() + " have won!!!");
        } else if (player2.getIsLost()) {
            log.info("com.battleship.model.Player: " + this.player1.getUsername() + " have won!!!");
    ...
    private void checkAllSunkenShips(Player player){
        if (player.checkAllSunkenShips()){
            log.info("com.battleship.model.Player: " + player.getUsername() + " have no ships left on his board!!!!");
            player.setIsLost();
            gameOver();
        }
    }
    ...
    private boolean hitShip(Field field, Player player){
        ...
        if (!ship.isHit(field)) {
            ...
            log.info("You hit " + player.getUsername() + "'s" +
                    " ship! com.battleship.model.Ship is: " + ship.getShipType());
            if (ship.isSunken()){
